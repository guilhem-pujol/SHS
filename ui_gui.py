...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.statsPanel = QtGui.QWidget(self.leftSide)
        self.statsPanel.setMinimumSize(QtCore.QSize(200, 0))
        self.statsPanel.setObjectName(_fromUtf8("statsPanel"))
        self.verticalLayout_6 = QtGui.QVBoxLayout(self.statsPanel)
        self.verticalLayout_6.setMargin(0)
        self.verticalLayout_6.setObjectName(_fromUtf8("verticalLayout_6"))
        self.statsButton = QtGui.QPushButton(self.statsPanel)
        self.statsButton.setObjectName(_fromUtf8("statsButton"))
        self.verticalLayout_6.addWidget(self.statsButton)
        self.statsText = QtGui.QLabel(self.statsPanel)
        self.statsText.setMinimumSize(QtCore.QSize(0, 0))
        self.statsText.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.statsText.setText(_fromUtf8(""))
        self.statsText.setObjectName(_fromUtf8("statsText"))
        self.verticalLayout_6.addWidget(self.statsText)
        self.statsRange = QtGui.QLabel(self.statsPanel)
        self.statsRange.setMinimumSize(QtCore.QSize(0, 0))
        self.statsRange.setMaximumSize(QtCore.QSize(16777215, 20))
        self.statsRange.setText(_fromUtf8(""))
        self.statsRange.setObjectName(_fromUtf8("statsRange"))
        self.verticalLayout_6.addWidget(self.statsRange)
        self.textMostFrequent = QtGui.QLabel(self.statsPanel)
        self.textMostFrequent.setObjectName(_fromUtf8("textMostFrequent"))
        self.verticalLayout_6.addWidget(self.textMostFrequent)
        self.statsPos = QtGui.QComboBox(self.statsPanel)
        self.statsPos.setObjectName(_fromUtf8("statsPos"))
        ...
        self.statsResults.setEditTriggers(QtGui.QAbstractItemView.NoEditTriggers)
        self.statsResults.setSelectionMode(QtGui.QAbstractItemView.NoSelection)
        self.statsResults.setObjectName(_fromUtf8("statsResults"))
        self.statsResults.setColumnCount(2)
        self.statsResults.setRowCount(10)
        item = QtGui.QTableWidgetItem()
        self.statsResults.setVerticalHeaderItem(0, item)
        item = QtGui.QTableWidgetItem()
        self.statsResults.setVerticalHeaderItem(1, item)
        item = QtGui.QTableWidgetItem()
        self.statsResults.setVerticalHeaderItem(2, item)
        item = QtGui.QTableWidgetItem()
        self.statsResults.setVerticalHeaderItem(3, item)
        item = QtGui.QTableWidgetItem()
        self.statsResults.setVerticalHeaderItem(4, item)
        item = QtGui.QTableWidgetItem()
        self.statsResults.setVerticalHeaderItem(5, item)
        item = QtGui.QTableWidgetItem()
        self.statsResults.setVerticalHeaderItem(6, item)
        item = QtGui.QTableWidgetItem()
        self.statsResults.setVerticalHeaderItem(7, item)
        item = QtGui.QTableWidgetItem()
        self.statsResults.setVerticalHeaderItem(8, item)
        item = QtGui.QTableWidgetItem()
        self.statsResults.setVerticalHeaderItem(9, item)
        item = QtGui.QTableWidgetItem()
        self.statsResults.setHorizontalHeaderItem(0, item)
        item = QtGui.QTableWidgetItem()
        self.statsResults.setHorizontalHeaderItem(1, item)
        self.statsResults.horizontalHeader().setVisible(False)
        self.statsResults.horizontalHeader().setDefaultSectionSize(99)
        self.statsResults.verticalHeader().setVisible(False)
        self.verticalLayout_6.addWidget(self.statsResults)
        self.verticalLayout_2.addWidget(self.statsPanel)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.statsButton.setText(_translate("MainWindow", "Statistiques", None))
        self.textMostFrequent.setText(_translate("MainWindow", "Motifs les plus fréquents", None))
        self.statsPos.setItemText(0, _translate("MainWindow", "Toutes les positions", None))
        self.statsPos.setItemText(1, _translate("MainWindow", "1", None))
        self.statsPos.setItemText(2, _translate("MainWindow", "10", None))
        self.statsPos.setItemText(3, _translate("MainWindow", "11", None))
        self.statsPos.setItemText(4, _translate("MainWindow", "12", None))
        self.statsPos.setItemText(5, _translate("MainWindow", "2", None))
        self.statsPos.setItemText(6, _translate("MainWindow", "20", None))
        self.statsPos.setItemText(7, _translate("MainWindow", "21", None))
        self.statsPos.setItemText(8, _translate("MainWindow", "22", None))
        self.statsPos.setItemText(9, _translate("MainWindow", "3", None))
        self.statsPos.setItemText(10, _translate("MainWindow", "30", None))
        self.statsPos.setItemText(11, _translate("MainWindow", "31", None))
        self.statsPos.setItemText(12, _translate("MainWindow", "32", None))
        self.statsPos.setItemText(13, _translate("MainWindow", "4", None))
        self.statsPos.setItemText(14, _translate("MainWindow", "40", None))
        self.statsPos.setItemText(15, _translate("MainWindow", "41", None))
        self.statsPos.setItemText(16, _translate("MainWindow", "42", None))
        self.statsPos.setItemText(17, _translate("MainWindow", "5", None))
        self.statsPos.setItemText(18, _translate("MainWindow", "50", None))
        self.statsPos.setItemText(19, _translate("MainWindow", "51", None))
        ...
        item = self.statsResults.verticalHeaderItem(2)
        item.setText(_translate("MainWindow", "2", None))
        item = self.statsResults.verticalHeaderItem(3)
        item.setText(_translate("MainWindow", "3", None))
        item = self.statsResults.verticalHeaderItem(4)
        item.setText(_translate("MainWindow", "4", None))
        item = self.statsResults.verticalHeaderItem(5)
        item.setText(_translate("MainWindow", "5", None))
        item = self.statsResults.verticalHeaderItem(6)
        item.setText(_translate("MainWindow", "6", None))
        item = self.statsResults.verticalHeaderItem(7)
        item.setText(_translate("MainWindow", "7", None))
        item = self.statsResults.verticalHeaderItem(8)
        item.setText(_translate("MainWindow", "8", None))
        item = self.statsResults.verticalHeaderItem(9)
        item.setText(_translate("MainWindow", "10", None))
        item = self.statsResults.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Letters", None))
        item = self.statsResults.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Masks", None))
